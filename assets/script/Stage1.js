...
cc.Class({
    ...
    _tryMoveMap: function(moveDir) {
        ...
        if (newPos) {
            // calculate the position range of map 我记得这段好像有问题，官方范例完全写错逻辑！
            // todo: 其实可以用摄像头来做，完了看看改改,其实就是钳住地图边缘
            ...
            cc.log("maxX,visiblerect.left.x,y", maxX,maxY,minX,minY);
